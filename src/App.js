...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    .then(response => {
        ...
        this.setState({
          dataTimeline: data,
          dataTimeline30: data.slice(1).slice(-30),
          data_text: {
  ...
  render() {
    ...
    const { dataTimeline, dataTimeline30, data_text, data_pie } = this.state;
    return (
      <div className={classes.root}>
        ...
        <Container>
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} sm={3}>
              <Paper className={`${classes.paper} ${classes.confirmedText}`}>
            ...
            <Grid item xs={6} sm={3}>
              <Paper className={`${classes.paper} ${classes.hospitalizedText}`}>
            ...
            <Grid item xs={6} sm={3}>
              <Paper className={`${classes.paper} ${classes.deathsText}`}>
            ...
            <Grid item xs={6} sm={3}>
              <Paper className={`${classes.paper} ${classes.recoveredText}`}>
        ...
        <footer className={classes.footer}>
          <Paper className={classes.paper}>
            ...
            <Typography component="p">
              forked from @<a href="https://github.com/KarnYong/react-material-ui-dashboard-covid-19">KarnYong</a>
            </Typography>
          </Paper>
        </footer>
      </div>
